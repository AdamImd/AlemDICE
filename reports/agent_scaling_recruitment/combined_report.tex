...
E1, the hosted E2b language-model screen, and E3 remain prospective.  A
provider-free E2d2 replication has now promoted a deterministic joint exact
allocator under truthful public claims; this is allocation evidence rather
than an LLM or Alem efficacy result.  E1 will measure the unchanged GPT-5.4
...
E2: RecruitmentArena-6 & \pass{} provider-free / \pending{} hosted &
TFP1, arena, policies, selectors, oracle, and the staged E2b harness are
implemented.  E2d2 promoted joint exact allocation; E2b has passed fake-client
orchestration only and has made no hosted call.\\
